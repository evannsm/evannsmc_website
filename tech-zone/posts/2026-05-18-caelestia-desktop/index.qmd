...
The post-install half of [Article 03 (Arch + LUKS + Btrfs + Caelestia)](../2026-05-17-arch-luks-btrfs-caelestia/), split out into its own article because the desktop setup is independent of the underlying install. You can follow this on top of any working Arch base — LUKS+Btrfs, plain ext4, dual-boot, whatever. The commands below all run *inside* a booted, networked Arch system with a regular user account.
