...
sudo nvim /etc/hosts            # update the 127.0.1.1 line to match
```

Then open a new shell (or log out / log back in) — your current shell cached `$HOSTNAME` at startup and won't update in place.
:::
