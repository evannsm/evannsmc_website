    ...
    <div class="events-shell">
      ...
      <div class="events-scroll">
        ...
        <div class="season-block">
          ...
          <article class="event-card">
            <p class="event-title">Resume Review Workshop · January 22, 2026</p>
            <ul class="event-list">
          ...
          <article class="event-card">
            <p class="event-title">Cafezinho com Brasa · January 29, 2026</p>
            <ul class="event-list">
          ...
          <article class="event-card">
            <p class="event-title">Joint General Body Meeting with ALPFA and Cisco · February 3, 2026</p>
            <ul class="event-list">
          ...
          <article class="event-card">
            <p class="event-title">World Baseball Classic Watch Party · March 6, 2026</p>
            <ul class="event-list">
