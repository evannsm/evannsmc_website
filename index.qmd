  ...
  <section class="home-hero">
    ...
    <aside class="home-hero-sidebar">
      ...
      <div class="home-focus-card">
        <p class="home-focus-kicker">Focus areas</p>
        <p class="home-focus-title">What currently takes up the whiteboard.</p>
        <div class="home-focus-tags" aria-label="Research focus areas">
          <span class="home-focus-tag">Robotics</span>
          <span class="home-focus-tag">Safety</span>
          <span class="home-focus-tag">Python</span>
          <span class="home-focus-tag">JAX</span>
          <span class="home-focus-tag">Research</span>
          <span class="home-focus-tag">Quadrotors</span>
          <span class="home-focus-tag">Control</span>
        </div>
      </div>
    </aside>
  </section>
