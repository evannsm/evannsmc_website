...
::: {.d-flex .gap-2 .mb-3}
[View Python Version](https://github.com/evannsm/newton_raphson_px4){.btn .btn-sm .btn-primary target="_blank"}
[View C++ Version](https://github.com/evannsm/newton_raphson_px4_cpp){.btn .btn-sm .btn-primary target="_blank"}
:::
