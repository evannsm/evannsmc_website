...
**Vicon4PX4** and **OptiTrack4PX4** are my ROS 2 C++ packages that handle the entire pipeline — coordinate frame conversion, EKF fusion, and full-state relay — so you can focus on your controller, not the plumbing, regardless of the motion capture system your lab uses.
...
git clone git@github.com:evannsm/vicon4px4.git       # or optitrack4px4
