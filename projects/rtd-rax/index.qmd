...
.rtd-website-btn:hover,
.rtd-website-btn:focus {
  background: rgba(194, 65, 12, 0.18) !important;
  border-color: rgba(194, 65, 12, 0.35) !important;
  color: #7c2d12 !important;
}
body.quarto-dark .rtd-website-btn {
  background: rgba(251, 146, 60, 0.12) !important;
  border-color: rgba(251, 146, 60, 0.25) !important;
  color: #fdba74 !important;
}
body.quarto-dark .rtd-website-btn:hover,
body.quarto-dark .rtd-website-btn:focus {
...
[Official RTD-RAX Website](https://evannsmc.github.io/ws_RTD){.btn .btn-sm .rtd-website-btn target="_blank"}
[MECC-ALDSC Paper (Preprint PDF)](https://arxiv.org/abs/2603.21635){.btn .btn-sm .btn-primary target="_blank"}
[View on GitHub](https://github.com/evannsmc/rtd-rax){.btn .btn-sm .btn-outline-primary target="_blank"}
:::

<!-- ::: {.d-flex .gap-2 .mb-3}
[View on GitHub](https://github.com/evannsmc/rtd-rax){.btn .btn-sm .btn-primary target="_blank"}
[Dedicated Website (it's really nice)](https://evannsmc.github.io/ws_RTD){.btn .btn-sm .btn-outline-primary target="_blank"}
::: -->
