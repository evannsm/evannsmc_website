    ...
    <details class="project-card">
      <summary>
        <div class="project-summary">
          <div class="project-copy">
            ...
            <p class="project-preview-copy">
              Runtime assurance for uncertain systems using interval signal temporal logic, focused on reasoning about temporal specifications under bounded uncertainty.
            </p>
          </div>
          <div class="project-preview-panel">
            <div class="project-preview-custom">
              ...
              <div class="project-preview-lines">
                <div class="project-preview-line">Interval Signal Temporal Logic</div>
                <div class="project-preview-line">Uncertain nonlinear systems</div>
                <div class="project-preview-line">Runtime assurance guarantees</div>
              </div>
              <div class="project-preview-metrics">
                <span class="project-preview-metric">iSTL</span>
                <span class="project-preview-metric">NAHS</span>
                <span class="project-preview-metric">Safety</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="project-body">
        <div class="project-body-grid">
          <div class="project-detail-copy">
            <p>
              This project studies how to certify uncertain system behavior against temporal logic requirements without collapsing everything into worst-case conservatism. The core idea is to use interval signal temporal logic to reason directly about bounded uncertainty and preserve meaningful runtime-assurance guarantees.
            </p>
            <ul class="project-detail-list">
              <li>Targets uncertain systems where temporal requirements matter, not just pointwise state constraints.</li>
              <li>Builds on interval reasoning to keep guarantees interpretable under bounded uncertainty.</li>
              <li>Represents the formal-methods side of the same safe-autonomy thread that shows up in the planning and control work.</li>
            </ul>
          </div>
          <div class="project-actions">
