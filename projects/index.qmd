...
.project-card:hover {
  border-color: color-mix(in srgb, var(--projects-accent) 28%, var(--projects-border));
}
...
.project-toggle:focus-visible {
  outline: 2px solid color-mix(in srgb, var(--projects-accent) 45%, transparent);
          ...
          <div class="project-body">
            <div class="project-body-grid">
              ...
              <div class="project-actions">
                ...
                <a class="project-action secondary" href="https://evannsm.github.io/ws_RTD" target="_blank">Official RTD-RAX Website ↗</a>
              </div>
              <div class="project-actions">
            ...
            <div class="project-summary">
              <div class="project-copy">
                ...
                <div class="project-name-row">
                  <div class="project-name-group">
                    <span class="project-number">01</span>
                    <p class="project-name">MoCap4ROS2</p>
                  </div>
                  <button class="project-toggle" type="button" aria-label="Hide or show details"></button>
                </div>
                <p class="project-preview-copy">
                  Two companion ROS 2 C++ packages that bridge Vicon and OptiTrack motion-capture systems to the PX4 autopilot EKF for indoor quadrotor flight experiments. Handles coordinate conversion, quaternion reordering, timestamping, and full-state relay out of the box.
                </p>
                <p class="project-cta-hint">Tap anywhere on this panel to open the project page.</p>
              </div>
              <div class="project-preview-panel">
          ...
          <div class="project-body">
            <div class="project-body-grid">
              <div class="project-detail-copy">
                ...
                <ul class="project-detail-list">
                  <li>Vicon4PX4 connects via the DataStream SDK (vendored — no system install). OptiTrack4PX4 connects via NatNet.</li>
              ...
              <div class="project-actions">
                <a class="project-action" href="https://github.com/evannsm/vicon4px4" target="_blank">Vicon4PX4 GitHub ↗</a>
                <a class="project-action" href="https://github.com/evannsm/optitrack4px4" target="_blank">OptiTrack4PX4 GitHub ↗</a>
              </div>
            </div>
          </div>
        </details>
