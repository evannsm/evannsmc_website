    ...
    <details class="project-card">
      <summary>
        <div class="project-summary">
          ...
          <div class="project-preview-panel">
            <div class="project-preview-custom">
              <p class="project-preview-title">Mocap to estimator</p>
              <div class="project-preview-lines">
    ...
    <details class="project-card">
      <summary>
        <div class="project-summary">
          ...
          <div class="project-preview-panel">
            <div class="project-preview-custom">
              <p class="project-preview-title">Academic foundation</p>
              <div class="project-preview-lines">
                <div class="project-preview-line">ACC 2024</div>
                <div class="project-preview-line">TCST 2025</div>
                <div class="project-preview-line">Raspberry Pi 4 deployment</div>
              </div>
              <div class="project-preview-metrics">
    ...
    <details class="project-card">
      <summary>
        <div class="project-summary">
          ...
          <div class="project-preview-panel">
            <div class="project-preview-custom">
              <p class="project-preview-title">Trajectory set</p>
              <div class="project-preview-lines">
                <div class="project-preview-line">Hover</div>
                <div class="project-preview-line">Circle</div>
                <div class="project-preview-line">Figure-8 + Helix</div>
              </div>
              <div class="project-preview-metrics">
