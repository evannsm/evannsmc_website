...
.page-columns {
  grid-template-columns: [screen-start] 1rem [screen-start-inset] 0 [page-start] 0 [page-start-inset] 0 [body-start-outset] 0 [body-start] 0 [body-content-start] 1fr [body-content-end] 0 [body-end] 0 [body-end-outset] 0 [page-end-inset] 0 [page-end] 0 [screen-end-inset] 1rem [screen-end] !important;
}
...
<div class="projects-shell">
  <p class="projects-page-title">Projects.</p>

  <div class="projects-columns">
    <!-- LEFT COLUMN: Research Projects -->
    <div>
      <p class="projects-column-heading">Research Projects</p>
      <p class="projects-column-title">Published and in-progress research work.</p>
      <p class="projects-column-intro">
        Core research projects behind the quadrotor safety, control, and formal-methods work.
      </p>
