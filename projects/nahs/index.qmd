...
<div class="nahs-figure-shell">
  ...
  <p class="nahs-figure-caption">
    Top: a nominal controller generates an unsafe blimp trajectory, while the runtime-assurance layer synthesizes a safe backup trajectory online under bounded disturbance. Bottom: the full control architecture, where a nominal policy feeds the runtime-assurance block, which synthesizes a safe reference at 2 Hz, up-samples it with polynomial splines to 50 Hz, and passes it to a Newton-Raphson Flow controller on the blimp.
  </p>
</div>
```
