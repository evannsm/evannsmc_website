...
.about-feature-toggle[aria-expanded="true"]::after {
  content: 'Hide details';
}

.about-feature-toggle:hover,
.about-feature-toggle:focus-visible {
  color: var(--about-accent);
}
...
<div class="about-shell">
  ...
  <section class="about-feature-panel">
    <div class="about-feature-copy">
      <button class="about-feature-title about-feature-toggle" type="button" aria-expanded="false" aria-controls="about-bori-moments">
    ...
    <div class="about-feature-moments" id="about-bori-moments" hidden>
  ...
  <section class="about-hobbies-panel">
    ...
    <p class="hobbies-copy">
      A lot of the non-research side of my life still comes back to culture, creativity, and being with people. That usually means staying active, cooking, dancing, reading, writing, and making time for spaces that feel alive rather than purely technical.
    </p>

    <div class="about-hobbies-grid">
      <article class="about-hobby-card">
        <p class="about-hobby-card-title">Fitness</p>
        <p>Staying active helps me reset, keep some balance, and make sure life does not collapse entirely into code, papers, and lab work.</p>
      </article>
      <article class="about-hobby-card">
      ...
      <article class="about-hobby-card">
        <p class="about-hobby-card-title">Reading &amp; Writing</p>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var boriToggle = document.querySelector('.about-feature-toggle');
  var boriMoments = document.getElementById('about-bori-moments');

  if (boriToggle && boriMoments) {
    boriToggle.addEventListener('click', function () {
      var isExpanded = boriToggle.getAttribute('aria-expanded') === 'true';
      boriToggle.setAttribute('aria-expanded', String(!isExpanded));
      boriMoments.hidden = isExpanded;
    });
  }
